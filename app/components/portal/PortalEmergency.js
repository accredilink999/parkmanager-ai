...
export default function PortalEmergency({ siteName, sitePhone }) {
  const numbers = [
  ...
  return (
    <div className="space-y-3 mt-1">
      {/* Emergency Button */}
      {sitePhone && (
        <a href={`tel:${sitePhone.replace(/\s/g, '')}`} className="block bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded-2xl p-6 text-center transition-colors">
