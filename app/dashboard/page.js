  ...
  const sections = [
    {
      ...
      tiles: [
        ...
        { label: 'Initial Readings', desc: 'Set pre-app baselines', icon: (
        ...
        ), href: '/dashboard/initial-readings', from: 'from-amber-500', to: 'to-orange-400' },
      ],
    },
    {
      heading: 'Gas',
    ...
    },
    {
      ...
      tiles: [
        { label: 'Chat', desc: 'Message customers & staff', icon: (
        ...
        ), href: '/dashboard/chat', from: 'from-emerald-500', to: 'to-teal-400' },
