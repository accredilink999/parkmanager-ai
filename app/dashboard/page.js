...
export default function Dashboard() {
  ...
  const sections = [
    ...
    },
    {
      ...
      tiles: [
        { label: 'Gas Inventory', desc: 'Scan & track cylinders', icon: (
        ...
        { label: 'Delivery Session', desc: 'Receive & distribute cylinders', icon: (
        ...
        ), href: '/dashboard/gas?tab=delivery', from: 'from-amber-500', to: 'to-yellow-400' },
        { label: 'On-Site Register', desc: 'Live cylinders for fire regs', icon: (
