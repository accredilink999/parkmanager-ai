...
export default function CustomerPortal() {
  ...
  const tabs = [
    ...
    { key: 'chat', label: 'Chat', color: 'emerald', activeBg: 'bg-emerald-100', activeText: 'text-emerald-700', inactiveText: 'text-emerald-400', icon: (
      ...
      <div className="max-w-lg mx-auto px-4 mt-3">
        ...
        {loading ? (
          ...
          <>
            ...
            {tab === 'chat' && (
              <PortalChat user={user} siteName={siteName} sitePhone={sitePhone} />
            )}
            {tab === 'report' && (
